...
/Users/manuelfarzini/Personal/dev/repo/faust/build/bin/faust \
    ...
    /Users/manuelfarzini/Personal/dev/repo/faust/tests/impulse-tests/filesCompare /Users/manuelfarzini/Personal/dev/repo/faust/tests/impulse-tests/reference/$NAME.ir tmp/$NAME.ir > tmp/$NAME.cmp 2>&1
