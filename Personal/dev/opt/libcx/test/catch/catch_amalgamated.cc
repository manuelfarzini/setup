...
// NOTE: #1 (manu)
// I hacked this method to prevent displaying the banner.
...
void JsonReporter::testCaseEnded(TestCaseStats const &tcStats) {
...

    {
        ...
        // We do not write the test case totals, because there will always be just one test
        // case here.
